...
function showToRow(e, orgId){
  return {
    ...
    fi_live: !!e.fiLive,
    hotel: e.hotel || null,
    driver: (e.drivers && e.drivers.length) ? e.drivers : (e.noGround ? {noGround:true} : (e.driver || null)),
  ...
  try{
    ...
    for(const s of (shows || [])){
      ...
      events.push({
        ...
        drivers: Array.isArray(s.driver) ? s.driver : (s.driver && !s.driver.noGround ? [s.driver] : []),
        driver: Array.isArray(s.driver) ? (s.driver[0] || null) : (s.driver && !s.driver.noGround ? s.driver : null),
        noGround: !Array.isArray(s.driver) && !!(s.driver && s.driver.noGround),
