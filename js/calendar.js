...
function showBlock(e){
  ...
  return `<div class="ag-show" style="background:${c}" onclick="openView('event','${e.id}')">
    <div class="ag-show-b">${showListTitleHtml(e)}<span>${time}</span></div>
...
function eventRow(e){
  ...
  return `<div class="row" onclick="openView('event','${e.id}')">
    ...
    <div class="body">${showListTitleHtml(e)}<span>${esc(e.city)}${e.country?', '+esc(e.country):''} · ${e.setTime?esc(e.setTime):'—'}</span></div>
